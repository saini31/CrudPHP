...
<body>
    ...
    <div class="container mt-4">
        ...
        if (isset($_GET['search'])) {
            ...
            $sql = "SELECT * FROM crud2 WHERE name LIKE ? LIMIT ?, ?";
        ...
        if ($stmt->execute()) {
            ...
            echo "<thead>";
            echo "<tr>";
            echo "<th>Sr. No.<input type='text' class='form-control form-control-sm' id='name-filter' placeholder='sr. no.'></th>"; // Serial number column
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a class='btn btn-danger' href='edit.php?id={$row['id']}'>Edit</a> <a class='btn btn-danger'  href='delete.php?id={$row['id']}'>Delete</a></td>";
                echo "</tr>";
